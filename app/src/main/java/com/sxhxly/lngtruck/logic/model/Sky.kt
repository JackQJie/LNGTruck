package com.sxhxly.lngtruck.logic.model
...
private val sky = mapOf(
    ...
    "LIGHT_SNOW" to Sky("小雪",R.drawable.ic_light_snow,R.drawable.bg_clear_day),
    "MODERATE_SNOW" to Sky("中雪",R.drawable.ic_moderate_snow,R.drawable.bg_clear_day),
    "HEAVY_SNOW" to Sky("大雪",R.drawable.ic_heavy_snow,R.drawable.bg_clear_day),
    "STORM_SNOW" to Sky("暴雪",R.drawable.ic_heavy_snow,R.drawable.bg_clear_day),
    "HAIL" to Sky("冰雹",R.drawable.ic_hail,R.drawable.bg_clear_day),
    "LIGHT_HAZE" to Sky("轻度雾霾",R.drawable.ic_light_haze,R.drawable.bg_clear_day),
    "MODERATE_HAZE" to Sky("中度雾霾",R.drawable.ic_moderate_haze,R.drawable.bg_clear_day),
    "HEAVY_HAZE" to Sky("重度雾霾",R.drawable.ic_heavy_haze,R.drawable.bg_clear_day),
